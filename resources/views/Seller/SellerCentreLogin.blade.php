...
<html lang="en">
    ...
    <body class="bg-gray-100 min-h-screen flex flex-col">
        <header class="p-4">
            <a href="{{ url('/') }}" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded inline-block">
                Back to Main Page
            </a>
        </header>
        ...
        <main class="flex-grow flex items-center justify-center px-4">
            <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
                ...
                <form method="POST" action="{{ url('/Seller/SellerLogin/handle_seller_login_function') }}" id="loginForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="seller_id" id="seller_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
            ...
            // Removed the beforeunload confirmation
        </script>
    </body>
</html>